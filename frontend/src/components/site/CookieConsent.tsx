...
export function CookieConsent() {
  ...
  return (
    <section
      ...
      className="fixed inset-x-3 bottom-[max(.75rem,env(safe-area-inset-bottom))] z-[80] mx-auto max-w-[1120px] max-h-[calc(100dvh-1.5rem)] overflow-y-auto border border-white/20 bg-[var(--surface-sunken)] text-white shadow-[0_24px_80px_rgba(0,0,0,.55)] sm:inset-x-6 sm:bottom-6 sm:max-h-none sm:overflow-hidden"
    >
